...
import (
	...
	cinemaDelivery "backend/cinemaService/delivery"
	cinemaRepository "backend/cinemaService/repository"
	cinemaUsecase "backend/cinemaService/usecase"
	"io/ioutil"
	"log"
	movieDelivery "backend/movieService/delivery"
	movieRepository "backend/movieService/repository"
	movieUsecase "backend/movieService/usecase"
	"net/http"
	"os"
