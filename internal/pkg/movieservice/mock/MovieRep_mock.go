...
func (m *MockMovieRepository) GetMoviesInCinema(limit, page int) (*[]models.MovieList, error) {
	m.ctrl.T.Helper()
...
func (mr *MockMovieRepositoryMockRecorder) GetMoviesInCinema(limit, page interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetMoviesInCinema", reflect.TypeOf((*MockMovieRepository)(nil).GetMoviesInCinema), limit, page)
}
