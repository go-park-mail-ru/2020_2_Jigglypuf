...
box.once('init', function()
    ...
    box.schema.user.grant('Backend_cinema_interface', 'read,write,execute', 'function', 'create_session')
    box.schema.user.grant('Backend_cinema_interface', 'read,write,execute', 'function', 'check_session')
